...
public class EditTextPassword extends AppCompatEditText {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            this.showPasswordIcon = typedArray.getResourceId(R.styleable.EditTextPassword_showPasswordIcon, R.drawable.login_openeye);
            this.hidePasswordIcon = typedArray.getResourceId(R.styleable.EditTextPassword_hidePasswordIcon, R.drawable.login_closeeye);
