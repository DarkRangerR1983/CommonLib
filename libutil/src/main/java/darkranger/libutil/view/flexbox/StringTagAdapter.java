...
import darkranger.libutil.view.flexbox.adapter.TagAdapter;
...
public class StringTagAdapter extends TagAdapter<StringTagView, String> {
    ...
    private TagFlowLayoutClickListener mListener;

    public void setListener(TagFlowLayoutClickListener listener) {
        mListener = listener;
    }
