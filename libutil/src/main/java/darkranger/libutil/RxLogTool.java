    ...
    public static class Builder {
        public Builder() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && RxTool.getContext().getExternalCacheDir() != null)
                defaultDir = RxTool.getContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                defaultDir = RxTool.getContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }

        public Builder setLogSwitch(boolean logSwitch) {
            RxLogTool.sLogSwitch = logSwitch;
            return this;
        }

        public Builder setGlobalTag(final String tag) {
            if (isSpace(tag)) {
                RxLogTool.sGlobalTag = "";
                sTagIsSpace = true;
            } else {
                RxLogTool.sGlobalTag = tag;
                sTagIsSpace = false;
            }
            return this;
        }
        ...
        public Builder setLogHeadSwitch(boolean logHeadSwitch) {
            RxLogTool.sLogHeadSwitch = logHeadSwitch;
            return this;
        }

        public Builder setLog2FileSwitch(boolean log2FileSwitch) {
            RxLogTool.sLog2FileSwitch = log2FileSwitch;
            return this;
        }
        ...
        public Builder setDir(final String dir) {
            if (isSpace(dir)) {
                ...
                RxLogTool.dir = dir.endsWith(FILE_SEP) ? dir : dir + FILE_SEP;
            }
            return this;
        }

        public Builder setDir(final File dir) {
            RxLogTool.dir = dir == null ? null : dir.getAbsolutePath() + FILE_SEP;
            return this;
        }

        public Builder setBorderSwitch(boolean borderSwitch) {
            RxLogTool.sLogBorderSwitch = borderSwitch;
            return this;
        }

        public Builder setLogFilter(@TYPE int logFilter) {
            RxLogTool.sLogFilter = logFilter;
            return this;
        }
        ...
        public String toString() {
            return "switch: " + sLogSwitch
                    + LINE_SEP + "tag: " + (RxStringTool.isEmpty(sGlobalTag) ? "null" : sGlobalTag)
